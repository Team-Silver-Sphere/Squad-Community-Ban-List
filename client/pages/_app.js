...
export default function MyApp({ Component, pageProps }) {
  ...
  return (
    <ApolloProvider client={apolloClient}>
      <DefaultSeo
        color="#ffc40b"
        title="Squad Community Ban List"
        description="The Squad Community Ban List aims to protect the Squad community's integrity through collaboration and information sharing."
      />
      <Head>
