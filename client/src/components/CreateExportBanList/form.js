      ...
      <Row>
        <Col xs="12">
          <FormGroup>
            ...
            <FormText>
              Please provide a name for your export ban list so it can be identified in the future.
            </FormText>
        ...
        <Col xs="12">
          <FormGroup>
            ...
            <Input type="text" innerRef={register} name="server" invalid={errors.server?.message} />
            <FormText>
              Please provide us with the name of your community/server so we can see who is using
              SCBL.
            </FormText>
        ...
        <Col xs="12">
          <FormGroup>
            ...
            />
            <FormText>
              Please provide a threshold for your export ban list. Once the sum of the points for a
              player's bans exceeds this number they will be added to your export ban list.
            </FormText>
